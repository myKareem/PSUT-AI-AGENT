...
wavs_path = 'C:/Users/20220020/Desktop/TTS GP/jordanian_tts_data/wav_new'
...
for i, wav_path in tqdm(enumerate(waves), total=len(waves)):
    ...
    if i % 10 == 0: # save intermediate dict
        torch.save(pitch_dict, 'C:/Users/20220020/Desktop/TTS GP/jordanian_tts_data/processed/pitch_dict.pt')
...
pitch_dict = torch.load('C:/Users/20220020/Desktop/TTS GP/jordanian_tts_data/processed/pitch_dict.pt')
...
write_lines_to_file(path='C:/Users/20220020/Desktop/TTS GP/jordanian_tts_data/processed/mean_std.txt', 
                    lines=[f"mean: {mean}", 
                           f"std: {std}"])
